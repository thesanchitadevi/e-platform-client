                            ...
                            <Link className='py-2 text-xl text-slate-800 font-bold' to={`/category/${category.id}`}>
                                ...
                                <div className="flex flex-col items-center justify-center w-full max-w-sm mx-auto shadow-lg">
                                    ...
                                    <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-slate-800">
                                        <h3 className="py-2 font-bold tracking-wide text-center text-slate-800 uppercase dark:text-white">{category.name}</h3>

                                        <div className="flex items-center justify-between px-4 py-2 bg-slate-200 dark:bg-slate-700">
                                            <button className="px-2 py-1 text-xs font-semibold text-slate-900 uppercase transition-colors duration-300 transform">Download Course Details
                                            </button>
