...
const CheckOut = () => {
    ...
    return (
        <div>
            <div className="grid lg:w-1/2 mx-auto sm:px-10 py-5 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        ...
                        <div className="relative">
                            <input type="text" id="email" name="email" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-slate-500 focus:ring-slate-500" placeholder="type your.email@gmail.com here" />
                        ...
                        <div className="relative py-3">
                            ...
                            <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3 ">
                                ...
                                <h1 className='pl-3'> {user?.displayName}</h1>
                            </div>
                        </div>
                        <div className="flex">
                        ...
                        <div>
                            <label for="card-no" className="mt-4 mb-2 block text-sm font-medium">Price</label>
                            <h1 className="w-full rounded-md border border-gray-200 px-2 shadow-sm outline-none focus:z-10 focus:border-slate-500 focus:ring-slate-500 text-md font-semibold"  >
                                {courses.price} tk
                            </h1>
                        </div>
