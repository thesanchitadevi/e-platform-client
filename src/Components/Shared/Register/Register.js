...
const Register = () => {
    ...
    const { providerLogIn, createUserEmail, setUser, updateUserProfile, verifyEmail } = useContext(AuthContext);
            ...
            <div className="flex flex-col items-center mt-8 sm:justify-center sm:pt-0">
                <div className="w-full px-6  overflow-hidden bg-slate-200 shadow-lg sm:max-w-lg sm:rounded-lg">
                    ...
                    <div className="mt-4 text-grey-600 text-center">
                        ...
                        <span>
                            <Link className="text-slate-600 hover:underline" to='/login'>
                                Log in
                            </Link>
                        </span>
                    </div>
